...
<head>
  ...
  <link rel="canonical" href="https://www.wealthtrustcap.com/car-calculator" />

  <meta property="og:title" content="Car Goal Calculator | Plan Investments for Your Dream Car" />
  <meta property="og:description" content="Calculate the amount needed to buy your dream car using our easy and accurate Car Goal Calculator." />
  <meta property="og:url" content="https://www.wealthtrustcap.com/car-calculator" />
  <meta property="og:type" content="website" />
  <meta property="og:image" content="OG_IMAGE_URL" />

  <meta name="twitter:card" content="summary_large_image" />
  <meta name="twitter:title" content="Car Goal Calculator | Plan Investments for Your Dream Car" />
  <meta name="twitter:description" content="Calculate the amount needed to buy your dream car using our easy and accurate Car Goal Calculator." />
  ...
  <script type="application/ld+json">
    {
      ...
      ",
      "url": "https://www.wealthtrustcap.com/car-calculator"
    }
  </script>
        ...
        <div class="card sip-card shadow-sm">
          <div class="card-body p-4">
            <div class="d-flex align-items-center mb-3">
              <h2 class="h4 mb-0 me-2">Car <span class="text-success">Goal</span> Calculator</h2>
              <span class="badge bg-light text-secondary border ms-2">Target SIP</span>
            </div>
            <p class="text-muted small mb-4">
              Find the monthly SIP needed to afford your car budget (inflation-adjusted) over time.
            </p>
            ...
            <form class="calc-form" data-calculator="car">
              ...
              <div class="d-flex gap-2 align-items-center">
                ...
                <button class="btn btn-outline-secondary px-4" type="reset" id="carReset">Reset</button>
              </div>
            </form>
        ...
        <div class="card shadow-sm h-100">
          <div class="card-body p-4">
            ...
            <div class="mb-4" style="max-width: 300px; margin: auto;">
              <canvas id="carPieCanvas" height="200"></canvas>
            </div>
    ...
    $(function() {
      ...
      setupCalculatorForm(".calc-form", {
        onSuccess: function(d) {
          // API (Target SIP style):
          // wealth_amount, inflation_rate, expected_return, period (years),
          ...
          const ctx = document.getElementById("carPieCanvas").getContext("2d");
          if (carPieChart instanceof Chart) {
            carPieChart.data = pieData;
            carPieChart.update();
          } else {

...
<body>
    ...
    <section class="py-5 hero-section" style="background-color: #ffffff;">
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    ...
                    <div class="mb-2 p-3 rounded" style="background-color: #d9f5e5; display: flex; align-items: center;">
                        <img src="./public/assets/img/o11.png" alt="icon" style="width: 24px; height: 24px; margin-right: 10px;">
                        <strong>Trusted by <span style="font-weight: 600;">500+ families</span></strong>
                    </div>
                    <div class="mb-2 p-3 rounded" style="background-color: #d9f5e5; display: flex; align-items: center;">
                        <img src="./public/assets/img/o12.png" alt="icon" style="width: 24px; height: 24px; margin-right: 10px;">
                    ...
                    <div class="p-3 rounded" style="background-color: #d9f5e5; display: flex; align-items: center;">
                        <img src="./public/assets/img/o13.png" alt="icon" style="width: 24px; height: 24px; margin-right: 10px;">
                ...
                <div class="col-md-6 text-center">
                    <img src="./public/assets/img/m1.png" alt="Financial Expert" class="img-fluid" style="max-height: 400px;">
                </div>
    ...
    <section class="py-5" style="background-color: #fcf8f5;">
        <div class="container text-center">
            ...
            <div class="text-center mb-4">
                <img src="./public/assets/img/compound-growth-chart.png" alt="Compound Growth Chart" class="img-fluid" style="max-height: 400px;">
            </div>
    ...
    <section class="py-5" style="background-color: #fcf8f5;">
        <div class="container text-center">
            ...
            <div class="row g-3 justify-content-center mb-5">
                ...
                <div class="col-md-4">
                    <div class="p-4 rounded h-100" style="background-color: #ccf7d5;">
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-5 text-center mt-5 mt-md-0">
                    <img src="./public/assets/img/haveQuestion.png" alt="FAQ Bot" class="img-fluid mb-2" style="max-height: 280px;">

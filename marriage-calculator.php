        ...
        <div class="card sip-card shadow-sm">
          <div class="card-body p-4">
            <div class="d-flex align-items-center mb-3">
              <h2 class="h4 mb-0 me-2">Marriage <span class="text-success">Goal</span> Calculator</h2>
              <span class="badge bg-light text-secondary border ms-2">Target SIP</span>
            </div>
            <p class="text-muted small mb-4">
              Find the monthly SIP needed to fund your marriage goal (inflation-adjusted) over time.
            </p>

            <form class="calc-form" data-calculator="marriage">
              <!-- Target Amount -->
              ...
              <div class="d-flex gap-2 align-items-center">
                ...
                <button class="btn btn-outline-secondary px-4" type="reset" id="marriageReset">Reset</button>
              </div>
            </form>
        ...
        <div class="card shadow-sm h-100">
          <div class="card-body p-4">
            ...
            <div class="mb-4" style="max-width: 300px; margin: auto;">
              <canvas id="marriagePieCanvas" height="200"></canvas>
            </div>
    ...
    $(function() {
      ...
      setupCalculatorForm(".calc-form", {
        onSuccess: function(d) {
          ...
          const ctx = document.getElementById("marriagePieCanvas").getContext("2d");
          if (marriagePieChart instanceof Chart) {
            marriagePieChart.data = pieData;
            marriagePieChart.update();
          } else {
            marriagePieChart = new Chart(ctx, {
              type: "doughnut",
              data: pieData,
              options: {
                responsive: true,
      ...
      // Reset cleanup
      $("#marriageReset").on("click", function() {
        $(".result-box").addClass("d-none");
        if (marriagePieChart instanceof Chart) {
          marriagePieChart.destroy();
          marriagePieChart = null;
        }
      });

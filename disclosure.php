        ...
        <div class="container">
            ...
            <div class="mb-5">
                <div class="card-body">
                    ...
                    <p>
                        WealthTrust Capital is offered commissions for mutual fund business sourced under its own ARN code. The commission earned by the firm varies from fund house to fund house and from scheme to scheme. As per SEBI circular:
                        <strong>SEBI/IMD/CIR No. 4/168230/09</strong>, following are the details of the commission earned by WealthTrust Capital from various AMCs, whose products are being distributed:
                    </p>
                    <ul class="list-group list-group-flush mb-3">
                        ...
                        <li class="list-group-item">Are subject to change, without any prior consent and at the sole discretion and agreement between WealthTrust Capital and the respective AMCs.</li>
                        <li class="list-group-item">Apply only to investments subscribed into Regular/Distributor Plans, which involve payment of commission to MFDs. No upfront commission is paid to/received by WealthTrust Capital.</li>
                    ...
                    <p>
                        You can check the gross commissions earned by WealthTrust Capital in any particular financial year by clicking on the following link:
            ...
            <div class="">
                <div class="card-body">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">WealthTrust Capital deals only in Regular Plans of Mutual Fund schemes and earns a trailing commission on client investments.</li>
                        <li class="list-group-item">Disclosure of commission earnings is made to clients at the time of investment.</li>
                        <li class="list-group-item">Investors have the option to invest in Direct Plans of every Mutual Fund scheme, which come with a lower expense ratio. WealthTrust Capital does not earn any commission on Direct Plans and therefore does not deal in them.</li>
                    </ul>
                </div>
            </div>
        </div>

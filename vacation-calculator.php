...
<head>
  ...
  <!-- seo tag -->
  <meta name="description" content="Plan your travel fund with our Vacation Calculator. This tool helps estimate how much to save for future trips — for illustration purposes only.">
        ...
        <div class="card sip-card shadow-sm">
          <div class="card-body p-4">
            <div class="d-flex align-items-center mb-3">
              <h2 class="h4 mb-0 me-2">Vacation <span class="text-success">Goal</span> Calculator</h2>
              <span class="badge bg-light text-secondary border ms-2">Target SIP</span>
            </div>
            <p class="text-muted small mb-4">
              Find the monthly SIP needed to fund your vacation goal (inflation-adjusted) over time.
            </p>

            <form class="calc-form" data-calculator="vacation">
              <!-- Target Amount -->
              ...
              <div class="d-flex gap-2 align-items-center">
                ...
                <button class="btn btn-outline-secondary px-4" type="reset" id="vacationReset">Reset</button>
              </div>
            </form>
        ...
        <div class="card shadow-sm h-100">
          <div class="card-body p-4">
            ...
            <div class="mb-4" style="max-width: 300px; margin: auto;">
              <canvas id="vacationPieCanvas" height="200"></canvas>
            </div>
    ...
    $(function() {
      ...
      setupCalculatorForm(".calc-form", {
        onSuccess: function(d) {
          ...
          const ctx = document.getElementById("vacationPieCanvas").getContext("2d");
          if (vacationPieChart instanceof Chart) {
            vacationPieChart.data = pieData;
            vacationPieChart.update();
          } else {
            vacationPieChart = new Chart(ctx, {
              type: "doughnut",
              data: pieData,
              options: {
                responsive: true,
      ...
      // Reset cleanup
      $("#vacationReset").on("click", function() {
        $(".result-box").addClass("d-none");
        if (vacationPieChart instanceof Chart) {
          vacationPieChart.destroy();
          vacationPieChart = null;
        }
      });

...
<head>
  ...
  <title>WealthTrust | Target Amount SIP Calculator</title>
  ...
  <script type="application/ld+json">
    {
      ...
      ",
      "url": "https://www.wealthtrustcap.com/target-sip-calculator"
    }
  </script>
        ...
        <div class="card sip-card shadow-sm">
          <div class="card-body p-4">
            <div class="d-flex align-items-center mb-3">
              <h2 class="h4 mb-0 me-2">Target Amount <span class="text-success">SIP</span> Calculator</h2>
              <span class="badge bg-light text-secondary border ms-2">Goal SIP</span>
            </div>
            <p class="text-muted small mb-4">
              Find the monthly SIP needed to reach your target amount (optionally inflation-adjusted) over time.
            </p>

            <form class="calc-form" data-calculator="target-sip">
              <!-- Target Amount -->
        ...
        <div class="card shadow-sm h-100">
          <div class="card-body p-4">
            ...
            <div class="mb-4" style="max-width: 300px; margin: auto;">
              <canvas id="targetSipPieCanvas" height="200"></canvas>
            </div>
    ...
    $(function() {
      ...
      setupCalculatorForm(".calc-form", {
        onSuccess: function(d) {
          ...
          const ctx = document.getElementById("targetSipPieCanvas").getContext("2d");
          if (targetSipPieChart instanceof Chart) {
            targetSipPieChart.data = pieData;
            targetSipPieChart.update();
          } else {
            targetSipPieChart = new Chart(ctx, {
              type: "doughnut",
              data: pieData,
              options: {
                responsive: true,
      ...
      $("#targetSipReset").on("click", function() {
        ...
        if (targetSipPieChart instanceof Chart) {
          targetSipPieChart.destroy();
          targetSipPieChart = null;
        }
      });
